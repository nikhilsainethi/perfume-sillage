...
- **Catalog data:** curated hand-authored core, expanded with a normalized import from the [Parfumo Perfume Database 59k](https://www.kaggle.com/datasets/ibrahimqasimi/parfumo-perfume-database-59k-fragrances) (Kaggle, CC0) — reputable houses only, full pyramids, strong community engagement. Popularity shortlist originally informed by the [Kaggle "Perfume Dataset"](https://www.kaggle.com/datasets/ayushghawana/perfume-dataset) (CC BY 4.0).
