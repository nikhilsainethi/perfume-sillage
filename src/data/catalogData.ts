...
export const RAW: RawPerfume[] = [
  ...
  {
    id: 'club-de-nuit-milestone', name: 'Club de Nuit Milestone', brand: 'Armaf', type: 'clone', year: 2021, gender: 'masculine', conc: 'edp',
    inspiredBy: 'millesime-imperial',
    top: ['bergamot', 'lemon', 'melon', 'sea-salt'], heart: ['iris', 'jasmine'], base: ['musk', 'sandalwood', 'ambroxan'],
    perf: [7, 7, 7], seasons: ['spring', 'summer'],
    desc: 'The salty-fruity Millésime Impérial reading at a fraction of the price — melon and sea spray over clean musk, dialed a notch louder.',
  },
  {
    id: 'kismet-angel', name: 'Kismet Angel', brand: 'Maison Alhambra', type: 'clone', year: 2023, gender: 'unisex', conc: 'edp',
    inspiredBy: 'angels-share',
    top: ['rum', 'cinnamon'], heart: ['praline', 'tonka-bean', 'cedar'], base: ['vanilla', 'sandalwood', 'caramel'],
    perf: [8, 7, 7], seasons: ['autumn', 'winter'],
    desc: 'The community’s favorite Angels’ Share stand-in — boozy cognac warmth, praline and cinnamon-dusted vanilla for pocket change.',
  },
  {
    id: 'salvo-elixir', name: 'Salvo Elixir', brand: 'Maison Alhambra', type: 'clone', year: 2023, gender: 'masculine', conc: 'parfum',
    inspiredBy: 'sauvage-elixir',
    top: ['grapefruit', 'cinnamon', 'cardamom'], heart: ['lavender', 'nutmeg'], base: ['ambroxan', 'star-anise', 'sandalwood', 'amber'],
    perf: [8, 8, 8], seasons: ['autumn', 'winter'],
    desc: 'A spiced-lavender elixir in the Sauvage Elixir mold — dense, licorice-dark and built to project like the original.',
  },
  {
    id: 'detour-noir', name: 'Detour Noir', brand: 'Al Haramain', type: 'clone', year: 2018, gender: 'masculine', conc: 'edp',
    inspiredBy: 'noir-extreme',
    top: ['cardamom', 'saffron', 'mandarin'], heart: ['rose', 'orange-blossom'], base: ['amber', 'vanilla', 'sandalwood'],
    perf: [8, 7, 7], seasons: ['autumn', 'winter'],
    desc: 'The best-known budget road to Noir Extrême — cardamom and kulfi-style amber-vanilla with a quiet rose at the core.',
  },
  {
    id: 'club-de-nuit-iconic', name: 'Club de Nuit Iconic', brand: 'Armaf', type: 'clone', year: 2023, gender: 'masculine', conc: 'edp',
    inspiredBy: 'bleu-de-chanel',
    top: ['grapefruit', 'lemon', 'mint'], heart: ['ginger', 'jasmine', 'nutmeg'], base: ['incense', 'cedar', 'sandalwood', 'ambroxan'],
    perf: [8, 7, 7], seasons: ['spring', 'autumn'],
    desc: 'Armaf’s take on the blue-fragrance king — citrus over smoky incense and woods, widely cited as the closest Bleu alternative yet.',
  },
  {
    id: 'khamrah-qahwa', name: 'Khamrah Qahwa', brand: 'Lattafa', type: 'clone', year: 2023, gender: 'unisex', conc: 'edp',
    inspiredBy: 'intense-cafe',
    top: ['cinnamon', 'ginger'], heart: ['coffee', 'praline', 'rose'], base: ['vanilla', 'tonka-bean', 'benzoin'],
    perf: [8, 8, 8], seasons: ['autumn', 'winter'],
    desc: 'Spiced Arabic coffee poured over praline and vanilla — the gourmand-café mood of Intense Café with an oriental accent.',
  },
  {
    id: 'ma-amber-leather', name: 'Amber & Leather', brand: 'Maison Alhambra', type: 'clone', year: 2022, gender: 'unisex', conc: 'edp',
    inspiredBy: 'ombre-leather',
    top: ['cardamom', 'bergamot'], heart: ['leather', 'jasmine'], base: ['amber', 'patchouli', 'vetiver'],
    perf: [7, 7, 7], seasons: ['autumn', 'winter'],
    desc: 'A faithful desert-leather sketch of Ombré Leather — supple suede, cardamom and warm amber at an entry price.',
  },
];
